    ...
    return (
        <div className='container mx-auto my-4'>
            <div className='flex justify-between items-center'>
                ...
                <button className='px-2 py-1 border font-medium text-xl border-solid border-black shadow-[-7px_7px_0_#000]'>Get started</button>
            </div>
            <div className='my-8 text-center'>
                ...
                <form className='flex justify-between max-w-[500px] border border-black shadow-[-7px_7px_0_#000] mx-auto mt-10'>
                    <input type="email" placeholder='Your email' className='pl-4 outline-none' />
                    <button className=' p-4 active:bg-gray-600 active:text-white'>Subscribe</button>
                </form>
            </div>
        </div>
    );
